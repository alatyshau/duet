...
class WorkspaceMapper:
    ...
    def load_existing_header(self) -> str:
        """Сохраняет ручную документацию до первого разделителя."""
        ...
        try:
            ...
            if "\n---" in content:
                # rstrip предотвращает накопление пустых строк
    ...
    def generate_tree(self):
        ...
        Алгоритм:
        1. Загружает существующий заголовок из целевого файла (сохраняет ручные правки)
