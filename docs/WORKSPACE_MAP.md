...
├── AGENTS.md            # [MISSING DOCS!]
├── CLAUDE.md            # [MISSING DOCS!]
├── GEMINI.md            # [MISSING DOCS!]
├── LICENSE
...
├── TESTING_STRATEGY.md    # Стратегия тестирования Duet
...
└── templates/                # [MISSING DOCS!]
    ...
    │
    ├── _instructions/             # [MISSING DOCS!]
    │   ├── 1_mode_detection.md    # [MISSING DOCS!]
    │   ├── 4_planning.md          # [MISSING DOCS!]
    │   ├── 6_secretary.md         # [MISSING DOCS!]
    │   ├── 7_review.md            # [MISSING DOCS!]
    │   │
    │   ├── 2_common/                   # [MISSING DOCS!]
    │   │   ├── base_instructions.md    # [MISSING DOCS!]
    │   │   ├── current_role.md         # [MISSING DOCS!]
    │   │   ├── identification.md       # [MISSING DOCS!]
    │   │   ├── red_lines.md            # [MISSING DOCS!]
    │   │   ├── response_format.md      # [MISSING DOCS!]
    │   │   ├── thesaurus.md            # [MISSING DOCS!]
    │   │   └── timestamp.md            # [MISSING DOCS!]
    │   │
    │   ├── 3_dialogue/                     # [MISSING DOCS!]
    │   │   ├── comments_format.md          # [MISSING DOCS!]
    │   │   ├── dialectics.md               # [MISSING DOCS!]
    │   │   ├── discussion_principles.md    # [MISSING DOCS!]
    │   │   └── document_structure.md       # [MISSING DOCS!]
    │   │
    │   └── 5_execute/                      # [MISSING DOCS!]
    │       ├── execute_rules.md            # [MISSING DOCS!]
    │       └── state_machine.md            # [MISSING DOCS!]
    │
    └── roles/                              # [MISSING DOCS!]
